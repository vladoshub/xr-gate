...
SELECTED_DISPLAY_FREQUENCY_HZ_RAW="${XR_OPENVR_DISPLAY_FREQUENCY_HZ:-${XR_DISPLAY_FREQUENCY_HZ:-${DISPLAY_FREQUENCY_HZ:-$CONFIG_DISPLAY_FREQUENCY_HZ}}}"
...
for mode in "${BUILD_MODES[@]}"; do
  for freq in "${BUILD_FREQUENCIES[@]}"; do
    ...
    XR_OPENVR_DISPLAY_CONFIG="$XR_OPENVR_DISPLAY_CONFIG" \
