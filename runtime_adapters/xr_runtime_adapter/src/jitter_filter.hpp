...
struct RuntimeJitterFilterConfig {
  ...
  double hmd_velocity_smooth_alpha = 1.0;
  double tracker_velocity_smooth_alpha = 1.0;
  double hmd_angular_velocity_smooth_alpha = 1.0;
  double tracker_angular_velocity_smooth_alpha = 1.0;
  double hmd_position_smooth_alpha = 1.0;
  double tracker_position_smooth_alpha = 1.0;
  double hmd_orientation_smooth_alpha = 1.0;
  double tracker_orientation_smooth_alpha = 1.0;
};

class VectorDeadbandSmoothingFilter {
 public:
  void reset();
  void filter(float& x, float& y, float& z, double zero_threshold, double smooth_alpha = 1.0);
  void filter(double& x, double& y, double& z, double zero_threshold, double smooth_alpha = 1.0);
...
class PositionDeadbandFilter {
 public:
  void reset();
  void filter(float& x, float& y, float& z, double threshold_m, double smooth_alpha = 1.0);
  void filter(double& x, double& y, double& z, double threshold_m, double smooth_alpha = 1.0);
...
class OrientationDeadbandFilter {
 public:
  void reset();
  void filter(float& qw, float& qx, float& qy, float& qz, double threshold_rad, double smooth_alpha = 1.0);
  void filter(double& qw, double& qx, double& qy, double& qz, double threshold_rad, double smooth_alpha = 1.0);
...
class HmdJitterFilter {
 ...
 private:
  ...
  VectorDeadbandSmoothingFilter linear_velocity_;
  VectorDeadbandSmoothingFilter angular_velocity_;
};
...
class BodyTrackerJitterFilter {
 ...
 private:
  ...
  std::array<VectorDeadbandSmoothingFilter, xr_tracking::BODY_TRACKER_MAX_TRACKERS> tracker_linear_velocities_{};
  std::array<VectorDeadbandSmoothingFilter, xr_tracking::BODY_TRACKER_MAX_TRACKERS> tracker_angular_velocities_{};
};

class RuntimeControllerStateJitterFilter {
 public:
  void reset();
 ...
 private:
  ...
  VectorDeadbandSmoothingFilter right_angular_velocity_;
};
...
class RuntimeJitterFilter {
 ...
 private:
  ...
  RuntimeControllerStateJitterFilter controller_state_{};
};
