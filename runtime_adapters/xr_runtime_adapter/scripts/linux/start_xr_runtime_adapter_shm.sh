...
RUNTIME_JITTER_FILTER_TRACKER_DEG_IMU="${RUNTIME_JITTER_FILTER_TRACKER_DEG_IMU:-${RUNTIME_JITTER_FILTER_TRACKER_DEG:-0.05}}" # IMU profile tracker/hand orientation jitter deadband in degrees
