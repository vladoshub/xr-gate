...
RUNTIME_HAND_TRACKING_PREDICTION_WINDOW_MS="${RUNTIME_HAND_TRACKING_PREDICTION_WINDOW_MS:-200}" # HAND_TRACKING rolling pose-history duration
...
RUNTIME_CONTROLLER_IMU_PREDICTION_WINDOW_MS="${RUNTIME_CONTROLLER_IMU_PREDICTION_WINDOW_MS:-200}" # IMU-controller rolling optical-pose history duration
