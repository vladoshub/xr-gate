...
RUNTIME_BODY_TRACKER_PREDICTION_DAMPING="${RUNTIME_BODY_TRACKER_PREDICTION_DAMPING:-0.8}" # velocity scale during body tracker prediction; 0 freezes, 1 keeps full velocity
RUNTIME_BODY_TRACKER_TIME_DECAY="${RUNTIME_BODY_TRACKER_TIME_DECAY:-1}" # 1 fades predicted velocity to zero by PREDICT_LOST_MS; 0 keeps the configured velocity scale until timeout
RUNTIME_BODY_TRACKER_MAX_PREDICTION_PATH_M="${RUNTIME_BODY_TRACKER_MAX_PREDICTION_PATH_M:-1.0}" # maximum accumulated body-tracker prediction path; 0 disables
...
RUNTIME_BODY_TRACKER_PREDICTION_WINDOW_MS="${RUNTIME_BODY_TRACKER_PREDICTION_WINDOW_MS:-120}" # body tracker rolling pose-history duration
...
RUNTIME_HAND_GATE_PREDICTION_DAMPING="${RUNTIME_HAND_GATE_PREDICTION_DAMPING:-1.0}" # velocity scale during lost-hand prediction; 0 freezes, 1 keeps full velocity
RUNTIME_HAND_TRACKING_TIME_DECAY="${RUNTIME_HAND_TRACKING_TIME_DECAY:-1}" # 1 fades HAND_TRACKING predicted velocity to zero by PREDICT_LOST_MS; 0 keeps the configured velocity scale until timeout
...
RUNTIME_HAND_TRACKING_PREDICTION_WINDOW_MS="${RUNTIME_HAND_TRACKING_PREDICTION_WINDOW_MS:-120}" # HAND_TRACKING rolling pose-history duration
RUNTIME_HAND_TRACKING_MAX_PREDICTION_PATH_M="${RUNTIME_HAND_TRACKING_MAX_PREDICTION_PATH_M:-0.65}" # maximum accumulated HAND_TRACKING prediction path; 0 disables
RUNTIME_HAND_TRACKING_MAX_DISTANCE_M="${RUNTIME_HAND_TRACKING_MAX_DISTANCE_M:-0.7}" # stop HAND_TRACKING prediction when farther than this from adjusted runtime HMD reference; 0 disables
...
RUNTIME_CONTROLLER_IMU_PREDICTION_WINDOW_MS="${RUNTIME_CONTROLLER_IMU_PREDICTION_WINDOW_MS:-120}" # IMU-controller rolling optical-pose history duration
RUNTIME_CONTROLLER_IMU_TIME_DECAY="${RUNTIME_CONTROLLER_IMU_TIME_DECAY:-0}" # 1 fades predicted velocity/acceleration to zero by PREDICT_LOST_MS; 0 keeps full response until timeout
RUNTIME_CONTROLLER_IMU_MAX_PREDICTION_SPEED_MPS="${RUNTIME_CONTROLLER_IMU_MAX_PREDICTION_SPEED_MPS:-2.0}" # cap final IMU-controller predicted position speed after acceleration integration; 0 disables
RUNTIME_CONTROLLER_IMU_MAX_PREDICTION_PATH_M="${RUNTIME_CONTROLLER_IMU_MAX_PREDICTION_PATH_M:-2.0}" # maximum accumulated IMU-controller prediction path; 0 disables
RUNTIME_CONTROLLER_IMU_MAX_DISTANCE_M="${RUNTIME_CONTROLLER_IMU_MAX_DISTANCE_M:-0.7}" # stop IMU-controller prediction when farther than this from adjusted runtime HMD reference; 0 disables
...
RUNTIME_CONTROLLER_IMU_ACCELERATION_DEADBAND_MPS2="${RUNTIME_CONTROLLER_IMU_ACCELERATION_DEADBAND_MPS2:-0.10}"
RUNTIME_CONTROLLER_IMU_MAX_LINEAR_ACCELERATION_MPS2="${RUNTIME_CONTROLLER_IMU_MAX_LINEAR_ACCELERATION_MPS2:-6.0}"
...
RUNTIME_CONTROLLER_IMU_YAW_CORRECTION_TRIGGER_HOLD_MS="${RUNTIME_CONTROLLER_IMU_YAW_CORRECTION_TRIGGER_HOLD_MS:-220}"
...
RUNTIME_CONTROLLER_HMD_RELATIVE_ENTER_BLEND_MS="${RUNTIME_CONTROLLER_HMD_RELATIVE_ENTER_BLEND_MS:-150}" # prediction/optical -> HMD-relative blend
RUNTIME_CONTROLLER_HMD_RELATIVE_EXIT_BLEND_MS="${RUNTIME_CONTROLLER_HMD_RELATIVE_EXIT_BLEND_MS:-250}" # HMD-relative -> reacquired optical blend
...
args=(
  ...
  --runtime-body-tracker-time-decay "$RUNTIME_BODY_TRACKER_TIME_DECAY"
  ...
  --runtime-hand-tracking-time-decay "$RUNTIME_HAND_TRACKING_TIME_DECAY"
  ...
  --runtime-controller-hmd-relative-enter-blend-ms "$RUNTIME_CONTROLLER_HMD_RELATIVE_ENTER_BLEND_MS"
  --runtime-controller-hmd-relative-exit-blend-ms "$RUNTIME_CONTROLLER_HMD_RELATIVE_EXIT_BLEND_MS"
  ...
  --runtime-controller-imu-time-decay "$RUNTIME_CONTROLLER_IMU_TIME_DECAY"
...
RUNTIME_BODY_TRACKER_PREDICTION_DAMPING=$RUNTIME_BODY_TRACKER_PREDICTION_DAMPING # body tracker prediction velocity scale
RUNTIME_BODY_TRACKER_TIME_DECAY=$RUNTIME_BODY_TRACKER_TIME_DECAY # fade body tracker predicted velocity over PREDICT_LOST_MS
...
RUNTIME_HAND_GATE_PREDICTION_DAMPING=$RUNTIME_HAND_GATE_PREDICTION_DAMPING # lost-hand prediction velocity scale
RUNTIME_HAND_TRACKING_TIME_DECAY=$RUNTIME_HAND_TRACKING_TIME_DECAY # fade HAND_TRACKING predicted velocity over PREDICT_LOST_MS
...
RUNTIME_CONTROLLER_HMD_RELATIVE_ENTER_BLEND_MS=$RUNTIME_CONTROLLER_HMD_RELATIVE_ENTER_BLEND_MS
RUNTIME_CONTROLLER_HMD_RELATIVE_EXIT_BLEND_MS=$RUNTIME_CONTROLLER_HMD_RELATIVE_EXIT_BLEND_MS
...
RUNTIME_CONTROLLER_IMU_TIME_DECAY=$RUNTIME_CONTROLLER_IMU_TIME_DECAY
