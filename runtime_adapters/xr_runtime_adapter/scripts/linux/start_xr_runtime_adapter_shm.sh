...
RUNTIME_HAND_GATE_PREDICTION_DAMPING="${RUNTIME_HAND_GATE_PREDICTION_DAMPING:-1.0}" # velocity damping during lost-hand prediction
...
RUNTIME_HAND_TRACKING_MAX_DISTANCE_M="${RUNTIME_HAND_TRACKING_MAX_DISTANCE_M:-1.0}" # stop HAND_TRACKING prediction when farther than this from adjusted runtime HMD reference; 0 disables
...
RUNTIME_CONTROLLER_IMU_TIME_DECAY="${RUNTIME_CONTROLLER_IMU_TIME_DECAY:-1}" # 1 fades predicted velocity/acceleration to zero by PREDICT_LOST_MS; 0 keeps full response until timeout
...
RUNTIME_CONTROLLER_IMU_MAX_DISTANCE_M="${RUNTIME_CONTROLLER_IMU_MAX_DISTANCE_M:-1.0}" # stop IMU-controller prediction when farther than this from adjusted runtime HMD reference; 0 disables
...
RUNTIME_CONTROLLER_IMU_LEVER_ARM_CENTRIPETAL_COMPENSATION="${RUNTIME_CONTROLLER_IMU_LEVER_ARM_CENTRIPETAL_COMPENSATION:-1}"
RUNTIME_CONTROLLER_IMU_LEVER_ARM_TANGENTIAL_COMPENSATION="${RUNTIME_CONTROLLER_IMU_LEVER_ARM_TANGENTIAL_COMPENSATION:-1}"
...
RUNTIME_CONTROLLER_IMU_ACCELERATION_DEADBAND_MPS2="${RUNTIME_CONTROLLER_IMU_ACCELERATION_DEADBAND_MPS2:-0.08}"
RUNTIME_CONTROLLER_IMU_MAX_LINEAR_ACCELERATION_MPS2="${RUNTIME_CONTROLLER_IMU_MAX_LINEAR_ACCELERATION_MPS2:-2.0}"
