...
RUNTIME_HAND_GATE_PREDICT_LOST_MS_IMU="${RUNTIME_HAND_GATE_PREDICT_LOST_MS_IMU:-${RUNTIME_HAND_GATE_PREDICT_LOST_MS:-1500}}" # IMU profile predict hand pose for this time after hold-lost phase
...
RUNTIME_CONTROLLER_LEFT_ORIENTATION_SOURCE="${RUNTIME_CONTROLLER_LEFT_ORIENTATION_SOURCE:-HAND_TRACKING_BACKEND}"
RUNTIME_CONTROLLER_RIGHT_ORIENTATION_SOURCE="${RUNTIME_CONTROLLER_RIGHT_ORIENTATION_SOURCE:-HAND_TRACKING_BACKEND}"
...
XR_BACKEND_CONTROL_FILE="${XR_BACKEND_CONTROL_FILE:-/tmp/xr_backend_control.json}" # shared backend control JSON; controller IMU gravity is read from gravity_magnitude
...
RUNTIME_CONTROLLER_IMU_YAW_CORRECTION_ALPHA="${RUNTIME_CONTROLLER_IMU_YAW_CORRECTION_ALPHA:-0.05}"
RUNTIME_CONTROLLER_IMU_YAW_CORRECTION_MAX_STEP_DEG="${RUNTIME_CONTROLLER_IMU_YAW_CORRECTION_MAX_STEP_DEG:-2.0}"
...
args=(
  ...
  --runtime-controller-imu-yaw-correction-alpha "$RUNTIME_CONTROLLER_IMU_YAW_CORRECTION_ALPHA"
  --runtime-controller-imu-yaw-correction-max-step-deg "$RUNTIME_CONTROLLER_IMU_YAW_CORRECTION_MAX_STEP_DEG"
...
XR_BACKEND_CONTROL_FILE=$XR_BACKEND_CONTROL_FILE # controller IMU gravity source; reads gravity_magnitude
...
RUNTIME_CONTROLLER_IMU_YAW_CORRECTION_ALPHA=$RUNTIME_CONTROLLER_IMU_YAW_CORRECTION_ALPHA
RUNTIME_CONTROLLER_IMU_YAW_CORRECTION_MAX_STEP_DEG=$RUNTIME_CONTROLLER_IMU_YAW_CORRECTION_MAX_STEP_DEG
