...
RUNTIME_BODY_TRACKER_MAX_PREDICTION_PATH_M="${RUNTIME_BODY_TRACKER_MAX_PREDICTION_PATH_M:-0.35}" # maximum accumulated body-tracker prediction path; 0 disables
RUNTIME_BODY_TRACKER_PREDICTION_WINDOW_MODE="${RUNTIME_BODY_TRACKER_PREDICTION_WINDOW_MODE:-0}" # 1 estimates prediction velocity from all real poses in a rolling window
RUNTIME_BODY_TRACKER_PREDICTION_WINDOW_MS="${RUNTIME_BODY_TRACKER_PREDICTION_WINDOW_MS:-500}" # body tracker rolling pose-history duration
...
RUNTIME_HAND_GATE_HOLD_LOST_MS_IMU="${RUNTIME_HAND_GATE_HOLD_LOST_MS_IMU:-${RUNTIME_HAND_GATE_HOLD_LOST_MS:-0}}" # IMU profile hold last valid hand pose after tracking loss
...
RUNTIME_HAND_TRACKING_PREDICTION_WINDOW_MODE="${RUNTIME_HAND_TRACKING_PREDICTION_WINDOW_MODE:-0}" # 1 estimates HAND_TRACKING prediction velocity from a rolling real-pose window
RUNTIME_HAND_TRACKING_PREDICTION_WINDOW_MS="${RUNTIME_HAND_TRACKING_PREDICTION_WINDOW_MS:-500}" # HAND_TRACKING rolling pose-history duration
RUNTIME_HAND_TRACKING_MAX_PREDICTION_PATH_M="${RUNTIME_HAND_TRACKING_MAX_PREDICTION_PATH_M:-0.35}" # maximum accumulated HAND_TRACKING prediction path; 0 disables
...
RUNTIME_CONTROLLER_IMU_PREDICTION_WINDOW_MODE="${RUNTIME_CONTROLLER_IMU_PREDICTION_WINDOW_MODE:-0}" # 1 estimates IMU-controller base velocity from a rolling optical-pose window
RUNTIME_CONTROLLER_IMU_PREDICTION_WINDOW_MS="${RUNTIME_CONTROLLER_IMU_PREDICTION_WINDOW_MS:-500}" # IMU-controller rolling optical-pose history duration
RUNTIME_CONTROLLER_IMU_MAX_PREDICTION_PATH_M="${RUNTIME_CONTROLLER_IMU_MAX_PREDICTION_PATH_M:-0.35}" # maximum accumulated IMU-controller prediction path; 0 disables
RUNTIME_CONTROLLER_IMU_LEVER_ARM_MODE="${RUNTIME_CONTROLLER_IMU_LEVER_ARM_MODE:-0}" # 1 curves only the Predicting-state trajectory from live IMU orientation
...
RUNTIME_CONTROLLER_IMU_YAW_CORRECTION_TRIGGER_HOLD_MS="${RUNTIME_CONTROLLER_IMU_YAW_CORRECTION_TRIGGER_HOLD_MS:-300}"
