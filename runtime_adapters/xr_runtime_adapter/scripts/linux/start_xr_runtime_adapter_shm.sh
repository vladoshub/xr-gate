...
RUNTIME_DERIVE_HAND_GESTURES="${RUNTIME_DERIVE_HAND_GESTURES:-0}" # derive pinch/grab gestures in runtime adapter
...
RUNTIME_LEFT_HAND_GESTURES_ENABLED="${RUNTIME_LEFT_HAND_GESTURES_ENABLED:-0}" # enable runtime gestures for left hand
RUNTIME_RIGHT_HAND_GESTURES_ENABLED="${RUNTIME_RIGHT_HAND_GESTURES_ENABLED:-0}" # enable runtime gestures for right hand
RUNTIME_DERIVE_EXTRA_GESTURE_BUTTONS="${RUNTIME_DERIVE_EXTRA_GESTURE_BUTTONS:-0}" # derive extra buttons from hand gestures
