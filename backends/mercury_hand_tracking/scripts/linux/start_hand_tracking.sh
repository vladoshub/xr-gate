...
MERCURY_SHADOW_REACQUIRE="${MERCURY_SHADOW_REACQUIRE:-1}"
MERCURY_SHADOW_RESTART_ONE_HAND_MS="${MERCURY_SHADOW_RESTART_ONE_HAND_MS:-250}"
MERCURY_SHADOW_RESTART_NO_HANDS_MS="${MERCURY_SHADOW_RESTART_NO_HANDS_MS:-250}"
MERCURY_SHADOW_PROMOTE_STABLE_FRAMES="${MERCURY_SHADOW_PROMOTE_STABLE_FRAMES:-5}"
