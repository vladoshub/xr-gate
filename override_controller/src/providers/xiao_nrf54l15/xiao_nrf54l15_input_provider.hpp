...
class XiaoNrf54l15InputProvider final : public InputProvider {
 public:
  explicit XiaoNrf54l15InputProvider(ProviderOptionValues options);
  ~XiaoNrf54l15InputProvider() override;

  std::string provider_name() const override { return "xiao_nrf54l15"; }
  bool requires_polling() const override { return true; }
